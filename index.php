  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/downloads/s1.png);">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(assets/img/downloads/about.jpeg);">
          <div class="carousel-container">
            <!-- <div class="carousel-content animate__animated animate__fadeInUp">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-left">
            <h3>Unite all Okinawan Karate in Pakistan!  <span>Welcome to the OTKUP!</span> </h3>
            <p> We are in the field of Karate since 1993.We started our journey from ShotoKan Karate as it is widely practicing style in Pakistan. After a quite few years an experienced instructor of Shito-Ryu and Gujo-Ryu join us and we started our journey together in 1996.</p>
          </div>
